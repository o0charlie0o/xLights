...
static  std::vector<std::pair<std::string, KBSCOPE>> KeyBindingTypes =
{
    ...
    { "PHONEME_ETC", KBSCOPE::Sequence },
    { "PHONEME_AI", KBSCOPE::Sequence },
    { "PHONEME_E", KBSCOPE::Sequence },
    { "PHONEME_O", KBSCOPE::Sequence },
    { "PHONEME_WQ", KBSCOPE::Sequence },
    { "PHONEME_FV", KBSCOPE::Sequence },
    { "PHONEME_MBP", KBSCOPE::Sequence },
    { "PHONEME_REST", KBSCOPE::Sequence },
    { "PHONEME_L", KBSCOPE::Sequence },
    ...
    { "SET_COLOR_1", KBSCOPE::Sequence },
    { "SET_COLOR_2", KBSCOPE::Sequence },
    { "SET_COLOR_3", KBSCOPE::Sequence },
    { "SET_COLOR_4", KBSCOPE::Sequence },
    { "SET_COLOR_5", KBSCOPE::Sequence },
    { "SET_COLOR_6", KBSCOPE::Sequence },
    { "SET_COLOR_7", KBSCOPE::Sequence },
    { "SET_COLOR_8", KBSCOPE::Sequence },
...
const std::vector<KeyBinding> DefaultBindings =
{
    ...
    KeyBinding("RIGHT", false, "DUPLICATE_RIGHT", false, true, true),
    KeyBinding("LEFT", false, "DUPLICATE_LEFT", false, true, true),
    KeyBinding("UP", false, "DUPLICATE_UP", false, true, true),
    KeyBinding("DOWN", false, "DUPLICATE_DOWN", false, true, true),
    ...
    KeyBinding("1", false, "SET_COLOR_1", true),
    KeyBinding("2", false, "SET_COLOR_2", true),
    KeyBinding("3", false, "SET_COLOR_3", true),
    KeyBinding("4", false, "SET_COLOR_4", true),
    KeyBinding("5", false, "SET_COLOR_5", true),
    KeyBinding("6", false, "SET_COLOR_6", true),
    KeyBinding("7", false, "SET_COLOR_7", true),
    KeyBinding("8", false, "SET_COLOR_8", true),
